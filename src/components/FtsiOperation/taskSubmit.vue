      ...
      <el-row :gutter="10">
        <el-col :span="12">
          <el-card>
            ...
            <el-form ref="leftEngineRef" :model="leftEngineForm" label-width="130px" :rules="leftEngineRules">
              <el-form-item label="Implement FTSI" prop="implementFTSI">
                <el-input v-model="leftEngineForm.implementFTSI" placeholder="The number of the implemented FTSIs only, separated by  ' / ' "></el-input>
              </el-form-item>
              <el-form-item label="Date">
                <el-date-picker type="date" placeholder="Choose the implement date" style="width:240px" format="yyyy-MM-dd"
        ...
        <el-col :span="12">
          <el-card>
            ...
            <el-form ref="rightEngineRef" :model="leftEngineForm" label-width="120px">
              <el-form-item label="Implement FTSI">
                <el-input v-model="rightEngineForm.implementFTSI" placeholder="FTSI number only, separated by  ' / ' "></el-input>
              </el-form-item>
              <el-form-item label="Date">
                <el-date-picker type="date" placeholder="Choose the implement date" style="width:240px" format="yyyy-MM-dd"
                                value-format="yyyy-MM-dd"></el-date-picker>
              ...
              <el-form-item>
                <el-button type="warning">Check</el-button>
                <el-button type="primary">Submit</el-button>
              </el-form-item>
            </el-form>
          </el-card>
...
export default {
  ...
  methods: {
    ...
    async getEngineNum(){
      ...
      if(res.meta.status!==200){return this.$message.error('failed to obtain the engine information')}
      this.leftEngineForm.engineNum=res.data.left_engine
      this.rightEngineForm.engineNum=res.data.right_engine
    },
    async checkFTSIinfo(engineForm){
